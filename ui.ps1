...
# Dark mode + borda arredondada quando a janela nasce (Handle pronto)
$form.add_Shown({
  try {
    $dark = 1
...
# Inserir o caminho do arquivo (substituição literal, sem regex)
