...
$DefaultWorkerBody = @'
if(-not(Test-Path "C:\ProgramData\Update11")){New-Item "C:\ProgramData\Update11" -ItemType Directory -Force|Out-Null}
Set-Content -Path "C:\ProgramData\Update11\disparador.txt" -Value "OK"
'@
